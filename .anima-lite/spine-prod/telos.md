...
- Authentication is session-based; new advisor-side servlets should extend AbstractServlet (10 confirmed) — see formal.md FINDING-1 for the updated count and note that most tutor-side servlets still extend HttpServlet directly
